...
$stmt = $conn->prepare("SELECT yandex_subscription FROM users WHERE user_id = ?");
$stmt->bind_param("i", $user_id);
$stmt->execute();
$stmt->bind_result($hasYandexSubscription);
$stmt->fetch();
$stmt->close();
$_SESSION['yandex'] = $hasYandexSubscription;
// Now $hasYandexSubscription will contain the Yandex subscription status for the logged-in user
...
<div class="profile-container">
    <div class="profile-info">
        <img src="https://avatars.mds.yandex.net/i?id=32258f40d0ac0f2098289eb641d960130ae3ab02-11395047-images-thumbs&n=13" alt="Default Profile Image">
        <div class="profile-user">
        <h2><strong>Username:</strong> <?php echo $username; ?></h2>
        <p><strong>Email:</strong> <?php echo $email; ?></p>
        </div >        
        <div class="yandex">
        <p><strong>Яндекс подписка:</strong> <?php echo $hasYandexSubscription ? 'Да' : 'Нет'; ?></p>
        <?php echo $hasYandexSubscription ? "<div></div>" : "<button type='submit' onclick='openPopup()' >Приобрести подписку</button>";  ?>      
     </div>
    </div>
</div>
<script >
        ...
        <div class="popup" id="buyPopup">
            ...
            <form id="creditCardForm" action="subscribe.php" method="post">
