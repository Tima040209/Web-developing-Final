...
$sql = "SELECT c.*, p.image_url, p.name, p.price FROM cart c
...
<body>
    ...
    ';
                ...
                <h1 id='category_name'>Корзина</h1>
    ...
    if (products.length === 0) {
        ...
        emptyCartMessage.innerText = "Ваша корзина пуста.";
        ...
        products.forEach(function (product) {
            ...
            buyButton.addEventListener("click", function () {
                // Implement the logic to handle the "Купить" button click
                // For example, you can redirect the user to a checkout page
            });

            var removeForm = document.createElement("form");
            removeForm.method = "post";
            removeForm.action = "delete.php"; // Change the action to your PHP script for removing from the cart
            ...
            removeButton.innerText = "Убрать из корзины";
            ...
            productCard.appendChild(removeForm);
