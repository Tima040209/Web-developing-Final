...
$category = isset($_GET['category']) ? $_GET['category'] : "дом"; // Задайте нужную категорию
...
var hasYandexSubscription = <?php echo json_encode($hasYandexSubscription); ?>;
products.forEach(function (product,index) {
    ...
    if (hasYandexSubscription===1 && (index + 1) % 2 === 0) {
            productPrice.innerText = "Цена со скидкой: " + (product.price * 0.7) + " тенге";
        } else {
    ...
    productCard.addEventListener("click", function () {
        ...
        window.location.href = 'product.php?product_id=' + product.id;
    });
